...
class DataFormController extends \App\Http\Controllers\Controller
{
    ...
    */
    ...
    public function postSaveRecord(Request $request) {
      ...
      if (env('APP_DEMO', false) === true && auth()->user()->id == 1 && $uuid !== null) {
        return response()->json(['status' => 'error', 'msg' => "This is a demo account. You can't update or delete anything. You can add new records."], 422);
      }
